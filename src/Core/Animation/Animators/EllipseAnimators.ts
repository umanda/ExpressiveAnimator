...
import type {EllipseElement} from "@zindex/canvas-engine";
import {VectorAnimators} from "./CommonAnimators";
import {PositiveNumberAnimation} from "./CommonAnimations";

export const EllipseAnimators: ElementAnimatorMap<EllipseElement> = {
    ...(VectorAnimators as ElementAnimatorMap<EllipseElement>),
    width: {
        id: 'width',
        title: 'Width',
        type: 'ellipse',
